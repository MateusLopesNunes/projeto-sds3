create table tb_sales (id bigint not null auto_increment, amount decimal(19,2) not null, date date not null, deals integer not null, visited integer not null, seller_id bigint, primary key (id)) engine=InnoDB;
create table tb_sellers (id bigint not null auto_increment, name varchar(255) not null, primary key (id)) engine=InnoDB;
